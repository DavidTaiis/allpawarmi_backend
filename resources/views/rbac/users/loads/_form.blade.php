    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                ...
                'off','id'=>'email', 'placeholder' => 'ej. 10xxxxxxxx', 'maxlength' => '10')) !!}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        {!! Form::label('status','* Pertenece a una asociación:', array('class' => 'control-label col-md-12')) !!}
        <div class="col-md-12">
            {!! Form::select('is_association', array( 'Yes' => 'SI', 'No' => 'No'),$user->is_association,array('class' => 'form-control') ) !!}
        </div>
    </div>
        @if ($user->id)
    <details>
